...
void InitializeOpcodes()
{
    ...
    OPCODE(SMSG_DAMAGE_CALC_LOG,                         STATUS_UNHANDLED,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    OPCODE(SMSG_OFFER_PETITION_ERROR,                    STATUS_UNHANDLED,    PROCESS_INPLACE,  &WorldSession::Handle_ServerSide               );
    ...
    OPCODE(CMSG_COMMENTATOR_ENABLE,                      STATUS_UNHANDLED,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE(SMSG_COMMENTATOR_STATE_CHANGED,               STATUS_UNHANDLED,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    OPCODE(CMSG_COMMENTATOR_GET_MAP_INFO,                STATUS_UNHANDLED,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE(SMSG_COMMENTATOR_MAP_INFO,                    STATUS_UNHANDLED,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    OPCODE(CMSG_COMMENTATOR_GET_PLAYER_INFO,             STATUS_UNHANDLED,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    //OPCODE(SMSG_COMMENTATOR_GET_PLAYER_INFO,             STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    OPCODE(SMSG_COMMENTATOR_PLAYER_INFO,                 STATUS_UNHANDLED,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    OPCODE(CMSG_COMMENTATOR_ENTER_INSTANCE,              STATUS_UNHANDLED,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE(CMSG_COMMENTATOR_EXIT_INSTANCE,               STATUS_UNHANDLED,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE(CMSG_COMMENTATOR_INSTANCE_COMMAND,            STATUS_UNHANDLED,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    OPCODE(SMSG_IGNORE_DIMINISHING_RETURNS_CHEAT,        STATUS_UNHANDLED, PROCESS_INPLACE, &WorldSession::Handle_ServerSide);
    ...
    OPCODE(SMSG_ARENA_TEAM_CHANGE_FAILED,                STATUS_UNHANDLED,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    OPCODE(CMSG_CONNECT_TO_FAILED,                       STATUS_UNHANDLED,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE(SMSG_SUSPEND_COMMS,                           STATUS_UNHANDLED,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    OPCODE(CMSG_COMMENTATOR_SKIRMISH_QUEUE_COMMAND,      STATUS_UNHANDLED,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE(SMSG_COMMENTATOR_SKIRMISH_QUEUE_RESULT1,      STATUS_UNHANDLED,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    OPCODE(SMSG_COMMENTATOR_SKIRMISH_QUEUE_RESULT2,      STATUS_UNHANDLED,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    OPCODE(CMSG_REQUEST_RATED_BG_INFO,                   STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleRequestRatedBgInfo        );
